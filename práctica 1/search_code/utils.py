...
class OrdenaQueue2(Queue):
    ...
    def append(self, value):
        self.A.append(value)
        self.A.sort(key = lambda value: value.path_cost + self.problem.h(value))
...
class OrdenaQueue1(Queue):
    ...
    def append(self, value):
        self.A.append(value)
        self.A.sort(key = lambda value: value.path_cost)
